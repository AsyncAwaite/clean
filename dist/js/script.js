...
window.addEventListener('DOMContentLoaded', function () {
  ...
  itemBtns.forEach(function (btn) {
    ...
    function activeCard() {
      ...
      var priceList = content.querySelector('.item-price__list');
      var mainItem = content.parentNode;
      var itemImg = mainItem.querySelector('.item-price__img');
      var item = content.parentNode;
      var itemDescr = item.querySelector('.item-price__descr');
