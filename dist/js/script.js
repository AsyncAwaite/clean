...
/* harmony import */ var _modules_scrollToAnchor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scrollToAnchor */ "./src/js/modules/scrollToAnchor.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_scrollToAnchor__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_popups__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkPhoneInputs() {
      ...
      inputs.forEach(function (input) {
        _this3.createMask(input);

        input.addEventListener("input", function () {
          if (input.value.indexOf("_") === -1) {
            input.classList.add("valid");
            input.nextElementSibling.textContent = "";
            _this3.req.phone = true;
          } else {
            input.classList.remove("valid");
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener("submit", function (e) {
          var btn = item.querySelector(".btn__form");
          var statusMessage = btn.nextElementSibling;
          e.preventDefault();

          if (_this4.req.phone && _this4.req.name) {
            statusMessage.textContent = _this4.message.loading;
            var formData = new FormData(item);

            _this4.postData(_this4.path, formData).then(function (res) {
              console.log(res);
              statusMessage.classList.add("form__message_ok");
              statusMessage.textContent = _this4.message.success;
            }).catch(function () {
              statusMessage.textContent = _this4.message.failure;
            }).finally(function () {
              _this4.clearInputs();
...
var popups = function popups() {
  ...
  function closePopup() {
    ...
    var form = new _forms__WEBPACK_IMPORTED_MODULE_1__["default"]("form").clearInputs();
  }
};
